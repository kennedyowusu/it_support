...
class InternetConnectivityIssuesContactForm extends StatefulWidget {
  @override
  _InternetConnectivityIssuesContactFormState createState() =>
      _InternetConnectivityIssuesContactFormState();
}

class _InternetConnectivityIssuesContactFormState extends State<InternetConnectivityIssuesContactForm> {
  ...
  validateAndSubmit() async {
    if (validateAndSave()) {
      ...
      try{
        ...
        await db.collection("internet_connectivity_issues").doc(user.uid).set({
          'uid': user.uid,
