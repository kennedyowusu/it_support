...
class InternetConnectivityIssuesRaised extends StatefulWidget {
  @override
  _InternetConnectivityIssuesRaisedState createState() => _InternetConnectivityIssuesRaisedState();
}

class _InternetConnectivityIssuesRaisedState extends State<InternetConnectivityIssuesRaised> {
  ...
  void removeFromDb(documentID) {
    db.collection('internet_connectivity_issues').doc(documentID).delete();
    // interact();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Internet Issues".toUpperCase()),
          elevation: 0,
          centerTitle: true,
